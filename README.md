...
字母人也會告訴你**現在到底有沒有人在錄**。這兩件事以前混在一起：`sister record`
是另一個執行檔，沒有人把它跑起來的時候暫停旗標是乾淨的，於是她顯示「在聽」——
而她什麼都沒在看。現在沒人開她的時候她是灰的，而且直接寫著「沒有人在記錄——
先跑 sister record」。和暫停長得不一樣，因為**下一步不一樣**：一個要按繼續，
一個要去把 recorder 開起來。判斷靠 recorder 每 5 秒蓋一次的時戳，不靠資料庫裡
