...
description: Query the user's local AI-Sister memory and return grounded text with source IDs. Use only when the user explicitly asks Codex to search, recall, or look up their own AI-Sister memory. Do not use for AI-Sister repository development, generic product questions, or while acting as AI-Sister's configured L2/L3 brain.
---
