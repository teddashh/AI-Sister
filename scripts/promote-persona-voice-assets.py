...
def main() -> None:
    ...
    try:
        ...
        (staging / "NOTICE.md").write_text(
            ...
            "missing. A few clips were re-recorded instead of edited: two speech "
            "recognition models trained on different data both transcribed syllables "
            "the written line does not contain, and those syllables run straight into "
            "the first word, leaving nothing to trim. Each was re-synthesised until "
            "neither model heard anything beyond the line, and the new take had to "
            "pass the same loudness, true-peak and speaker-identity checks as the one "
            "it replaced. No compression, limiting, or other dynamics processing was "
            "applied.\n\n"
